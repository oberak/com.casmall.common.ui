	...
	public void open() {
		try {
			...
			});
			{
				...
				lblSaveTerm.setFont(SWTResourceManager.getFont("굴림", 14, 1, false, false));
			}
			{
			...
			}
			{
				...
				cLabel2.setFont(SWTResourceManager.getFont("굴림", 11, 1, false, false));
			...
			}
			{
				...
				btnCancel.setFont(SWTResourceManager.getFont("굴림", 14, 1, false, false));
			...
			}
			{
				...
				cLabel1.setFont(SWTResourceManager.getFont("굴림", 11, 1, false, false));
			...
			}
			{
				...
				cLabel3.setFont(SWTResourceManager.getFont("굴림", 12, 1, false, false));
